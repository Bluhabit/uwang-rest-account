...
func main() {
	...
	r.GET("/", func(c *gin.Context) {
		...
		decode := common.DecodeJWT("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJibHVoYWJpdC5pZCIsInN1YiI6ImFkMWUzNGRhLTA3MzYtNDk1Ni1hNTk4LTUyODU5OTI2ZWQzNiIsImlhdCI6MTcwNzEyMDI4NCwiZXhwIjoxNzA3MTIzODg0fQ.nRGhNhwU0Dae_x4gePi87pOVr0NiAtbTsDORHqxKag8")
